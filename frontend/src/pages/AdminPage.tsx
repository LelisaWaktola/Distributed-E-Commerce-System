...
export default function AdminPage() {
    ...
    async function saveProduct() {
        ...
        try {
            if (editProduct.id) {
                await productApi.update(Number(editProduct.id), {
                        ...
                        <div>
                            ...
                            <div className="bg-blue-50 rounded-2xl p-5 text-sm text-blue-700">
                                ...
                                <ul className="space-y-1 text-xs">
                                    <li>{'Product management -> Product Service (Node 2, port 8082)'}</li>
                                    <li>{'Order management -> Order Service (Node 3, port 8083)'}</li>
                                    <li>{'User management -> User Service (Node 1, port 8081)'}</li>
                                    <li>{'Payment reports -> Payment Service (Node 4, port 8084)'}</li>
                                </ul>
                            </div>
                        </div>
                    )}
